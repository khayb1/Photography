...
export const Home = () => {
  ...
  <>
<div className="relative  flex items-center justify-center space-x-10 bg-cover bg-center hero px-8 " style={{background: "./"}} >

      {/* Content */}
      <div className="relative text-center max-w-3xl p-4 md:p-2 lg:p-12">
