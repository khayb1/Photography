      ...
      <div key={index} className="px-4"> 
        <div className="p-6 bg-slate-200 shadow-lg rounded-lg max-h-60 cursor-grab">
          <img
            ...
            className="w-20 h-20 rounded-xl mb-4 mx-auto"
          />
          <p className="text-gray-700 mb-4 text-center">"{testimonial.feedback}"</p>
          <h4 className="font-bold text-lg text-center">{testimonial.name}</h4>
        </div>
      </div>
    ))}
  </Slider>
